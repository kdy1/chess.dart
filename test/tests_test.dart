...
void main() {
  ...
  group("Get/Put/Remove", () {
    ...
    List positions = [
      {
        'pieces': {
          'a7': new Piece(type: PieceType.pawn, color: ChessColor.white),
          'b7': new Piece(type: PieceType.pawn, color: ChessColor.black),
          'c7': new Piece(type: PieceType.knight, color: ChessColor.white),
          'd7': new Piece(type: PieceType.knight, color: ChessColor.black),
          'e7': new Piece(type: PieceType.bishop, color: ChessColor.white),
          'f7': new Piece(type: PieceType.bishop, color: ChessColor.black),
          'g7': new Piece(type: PieceType.rook, color: ChessColor.white),
          'h7': new Piece(type: PieceType.rook, color: ChessColor.black),
          'a6': new Piece(type: PieceType.queen, color: ChessColor.white),
          'b6': new Piece(type: PieceType.queen, color: ChessColor.black),
          'a4': new Piece(type: PieceType.king, color: ChessColor.white),
          'h4': new Piece(type: PieceType.king, color: ChessColor.black)
        },
        'should_pass': true
      },
      {
        'pieces': {
          'j4': new Piece(type: PieceType.pawn, color: ChessColor.white)
        }, // bad square
        'should_pass': false
      },
    ];
  ...
  group("PGN", () {
    ...
    positions.forEach((position) {
      test(position["fen"], () {
        Chess chess = (position.containsKey("starting_position"))
            ? new Chess.fromFEN(position['starting_position'])
            : new Chess();
        bool passed = true;
  ...
  group('Regression Tests', () {
    ...
    test('Issue #32 - castling flag reappearing', () {
      Chess chess = new Chess.fromFEN(
          'b3k2r/5p2/4p3/1p5p/6p1/2PR2P1/BP3qNP/6QK b k - 2 28');
      chess.moveMap(from: cellIndex('a8'), to: cellIndex('g2'));
      expect(chess.fen,
